...
let
  ...
  baseExtensions =
    ...
    lib.mapAttrs (_n: lib.recurseIntoAttrs) {
      ...
      mcu-debug.peripheral-viewer = buildVscodeMarketplaceExtension {
        mktplcRef = {
        ...
        meta = {
          ...
          changelog = "https://marketplace.visualstudio.com/items/mcu-debug.peripheral-viewer/changelog";
          license = lib.licenses.mit;
          maintainers = [ lib.maintainers.hcsch ];
        };
      };
      ...
      ryanluker.vscode-coverage-gutters = buildVscodeMarketplaceExtension {
        ...
        meta = {
          changelog = "https://marketplace.visualstudio.com/items/ryanluker.vscode-coverage-gutters/changelog";
          description = "Display test coverage generated by lcov and xml - works with many languages";
          downloadPage = "https://marketplace.visualstudio.com/items?itemName=ryanluker.vscode-coverage-gutters";
          homepage = "https://github.com/ryanluker/vscode-coverage-gutters";
          license = lib.licenses.mit;
          maintainers = [ lib.maintainers.hcsch ];
        };
      };
